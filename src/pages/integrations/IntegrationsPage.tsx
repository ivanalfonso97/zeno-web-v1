    ...
    <div className="p-8">
      ...
      <div className="flex flex-col">
        <button
          ...
          "
        >
          <div className="flex flex-none items-center justify-center size-8 rounded-lg bg-white dark:bg-dark-surface lg:size-12">
            <svg className="size-4 lg:size-6" viewBox="0 0 24 24" fill="none">
          ...
          <div className="flex-1 text-left truncate">
            <h3 className="medium-bold text-dark truncate dark:text-white lg:large-bold">Google Calendar</h3>
            <p className="small-light text-gray truncate lg:medium-light">
          ...
          {isGoogleCalendarConnected ? (
            <i className="icon-regular bi bi-check-circle-fill text-support-green lg:icon-large"/>
          ) : (
            <i className="icon-regular bi bi-chevron-right"/>
          )}
        </button>
      </div>
    </div>
